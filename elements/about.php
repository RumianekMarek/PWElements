...
class PWElementAbout extends PWElements {
    ...
    public static function initElements() {
        $element_output = array(
            array(
                ...
                'group' => 'PWE Element',
                'heading' => __('Left text', 'pwe_element'),
            ...
            array(
                'type' => 'textarea_raw_html',
                'group' => 'PWE Element',
                'heading' => __('Right text (description)', 'pwe_element'),
    ...
    public static function output($atts) {  
        ...
        if (PWECommonFunctions::lang_pl()) {
            ...
            $default_desc_text = '[trade_fair_name] to jedyne w Polsce wydarzenie dedykowane branży [trade_fair_opisbranzy], które łączy innowacje, technologie i ekspertów. Targi to doskonała okazja do nawiązywania kontaktów i odkrywania najnowszych trendów w tej dziedzinie.';
        } else {
            $default_title_text = 'Discover market news and meet industry leaders – all in one place and time!';
            $default_desc_text = '[trade_fair_name_eng] is the only event in Poland dedicated to the [trade_fair_opisbranzy_eng], which combines innovation, technology and experts. The fair is a great opportunity to establish contacts and discover the latest trends in this field.';
        }
        ...
        <style>
            ...
            .pwe-discover-btns .pwe-discover-btns__heading_left h3 p {
                font-size: 28px; 
                color: black;
                line-height: 1.2;
                margin: 0;
            ...
            <div class="pwe-discover-btns__wrapper">
                ...
                <div class="pwe-discover-btns__container">
                    <div class="pwe-discover-btns__container_image ">
                        ...
                        <a href="'. self::languageChecker('/poznaj-targi/', '/en/explore-the-fair/') .'">'. self::languageChecker('Dowiedz się więcej', 'Learn more') .'</a>
                        </div>
                    </div>
                    <div class="pwe-discover-btns__container_image ">
