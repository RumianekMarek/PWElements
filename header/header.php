...
class PWEHeader extends PWECommonFunctions {
    ...
    public function PWEHeaderOutput($atts, $content = null) {
        ...
        $output = '
            ...
            if (glob($_SERVER['DOCUMENT_ROOT'] . '/doc/header_mobile.webp', GLOB_BRACE) && ($pwe_header_modes != "conference_mode" && $pwe_header_modes != "squares_mode" && $pwe_header_modes != "video_mode")) {
                $output .= '
                <style>
        ...
        $output .= '<div id="pweHeader" class="pwe-header">
            ...
            <div style="background-image: url('. $background_header .');"  class="pwe-header-container pwe-header-background">';
                ...
                if ($pwe_header_modes == "squares_mode" || $pwe_header_modes == "video_mode") {
                    $output .= '
