...
<div class="pwe-store__featured-service pwe-store__service pwe-store__sold-out" id="smycze">
    <div class="pwe-store__featured-content">
        <div class="pwe-store__featured-image">
            <img src="/wp-content/plugins/PWElements/media/store/premium/smycze-z-logotypem.webp" alt="Smyczki">
        </div>
        <div class="pwe-store__featured-details">
            ...
            <div class="pwe-store__featured-footer">
                <span class="pwe-store__featured-pwe-store__price">5500 zł '. ( self::lang_pl() ? 'netto' : 'net' ) .'</span>
...
<div class="pwe-store__featured-service pwe-store__service pwe-store__limit" id="logotyp">
    <div class="pwe-store__featured-content">
        <div class="pwe-store__featured-image">
            <img src="/wp-content/plugins/PWElements/media/store/premium/logotyp-na-identyfikatorach.webp" alt="Identyfikatory">
        </div>
        <div class="pwe-store__featured-details">
...
<div class="pwe-store__featured-service pwe-store__service" id="sponsor-planu">
    <div class="pwe-store__featured-content">
        <div class="pwe-store__featured-image">
            <img src="/wp-content/plugins/PWElements/media/store/premium/sponsor-planu-targowego.webp" alt="Plan Targowy">
        </div>
        <div class="pwe-store__featured-details">
...
<div class="pwe-store__featured-service pwe-store__service" id="vip-room">
    <div class="pwe-store__featured-content">
        <div class="pwe-store__featured-image">
            <img src="/wp-content/plugins/PWElements/media/store/premium/partner-vip-room.webp" alt="VIP Room">
        </div>
        <div class="pwe-store__featured-details">
...
<div class="pwe-store__featured-service pwe-store__service" id="sponsor-restauracji">   
    <div class="pwe-store__featured-content">
        <div class="pwe-store__featured-image">
            <img src="/wp-content/plugins/PWElements/media/store/premium/sponsor-resturacji.webp" alt="Restauracja">
        </div>
        <div class="pwe-store__featured-details">
...
<div class="pwe-store__featured-service pwe-store__service" id="sponsor-wieczoru">
    <div class="pwe-store__featured-content">
        <div class="pwe-store__featured-image">
            <img src="/wp-content/plugins/PWElements/media/store/premium/sponsor-gali.webp" alt="Sponsor Wieczoru Branżowego">
        </div>
        <div class="pwe-store__featured-details">
