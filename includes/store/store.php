    ...
    public function PWEStoreOutput() {   
        ...
        <div id="pweStore" class="pwe-store">
            ...
            <div class="pwe-store__main-section">
                ...
                <div class="pwe-store__main-section-text social" style="display: none;">
            ...
            <div class="pwe-store__hide-sections">
                ...
                <div id="premiumSectionHide" category="premium" class="pwe-store__premium-section-hide pwe-store__section-hide">
                    ...
                    <div class="pwe-store__featured-service pwe-store__service pwe-store__sold-out" id="smycze">
                    ...
                    <div class="pwe-store__featured-service pwe-store__service pwe-store__limit" id="logotyp">
                        <div class="pwe-store__featured-content">
                            <div class="pwe-store__featured-image">
                ...
                <div id="marketingSectionHide" category="marketing" class="pwe-store__marketing-section-hide pwe-store__section-hide">
                    ...
                    <!-- Spersonalizowane Smyczki -->
                    <div class="pwe-store__featured-service pwe-store__service" id="test">
                        <div class="pwe-store__featured-content">
                            <div class="pwe-store__featured-image">
                                <img src="/wp-content/plugins/PWElements/media/store/smycze-z-logotypem.webp" alt="Smyczki">
                            </div>
                            <div class="pwe-store__featured-details">
                                <h3 class="pwe-store__service-name">'. ( self::lang_pl() ? 'TEST' : 'TEST' ) .'</h3>
                                <span class="pwe-store__service-name-mailing">'. ( self::lang_pl() ? 'TEST' : 'TEST' ) .'</span>
                                <div class="pwe-store__featured-text">
                                '. ( self::lang_pl() ? '
                                    <p class="pwe-store__featured-description">Zareklamuj swoją markę podczas największych targów w Polsce! Na każde targi Ptak Warsaw Expo wysyłamy od <strong>30 000 badge ze smyczkami do nawet 100 000 badge</strong>  – teraz możesz sprawić, że to <strong>Twoje logo</strong> znajdzie się na smyczkach trafiających do uczestników i wystawców. To doskonała okazja na zwiększenie widoczności Twojej firmy wśród liderów branży.</p>
                ...
                <div id="socialSectionHide" category="social" class="pwe-store__social-section-hide pwe-store__section-hide">
                    ...
                    <!-- Spersonalizowane Smyczki -->
                    <div class="pwe-store__featured-service pwe-store__service" id="test1">
                        <div class="pwe-store__featured-content">
                            <div class="pwe-store__featured-image">
                                <img src="/wp-content/plugins/PWElements/media/store/smycze-z-logotypem.webp" alt="Smyczki">
                            </div>
                            <div class="pwe-store__featured-details">
                                <h3 class="pwe-store__service-name">'. ( self::lang_pl() ? 'TEST1' : 'TEST1' ) .'</h3>
                                <span class="pwe-store__service-name-mailing">'. ( self::lang_pl() ? 'TEST1' : 'TEST1' ) .'</span>
                                <div class="pwe-store__featured-text">
                                '. ( self::lang_pl() ? '
                                    <p class="pwe-store__featured-description">Zareklamuj swoją markę podczas największych targów w Polsce! Na każde targi Ptak Warsaw Expo wysyłamy od <strong>30 000 badge ze smyczkami do nawet 100 000 badge</strong>  – teraz możesz sprawić, że to <strong>Twoje logo</strong> znajdzie się na smyczkach trafiających do uczestników i wystawców. To doskonała okazja na zwiększenie widoczności Twojej firmy wśród liderów branży.</p>
            ...
            <div class="pwe-store__sorting">
                <div class="pwe-store__sorting-wrapper">
                    ...
                    <div class="pwe-store__sorting-items">
                        ...
                        <div id="social" class="pwe-store__sorting-item"><p>USŁUGI SOCIAL MEDIA</p></div>
                        <div id="packages" class="pwe-store__sorting-item"><p>PAKIETY</p></div>
                    </div>
                </div>
            </div>

            <div class="pwe-store__sections">
                ...
                <div id="marketingSection" category="marketing" class="pwe-store__marketing-section pwe-store__section">
                    <div class="pwe-store__services-cards">
                        <!-- Spersonalizowane Smyczki -->
                        <div class="pwe-store__service-card pwe-store__service">
                            <a href="#" data-featured="test">
                                <div class="pwe-store__service-image">
                                    <img src="/wp-content/plugins/PWElements/media/store/smycze-z-logotypem.webp" alt="Smycze z logotypem">
                                </div>
                                <div class="pwe-store__service-content">
                                    '. ( self::lang_pl() ? '
                                    <h4 class="pwe-store__service-name pwe-store__service-name-mailing">TEST</h4>
                                    <p>Test</p>
                                    ':'
                                    <h4 class="pwe-store__service-name pwe-store__service-name-mailing">TEST</h4>
                                    <p>Test</p>
                            ...
                            <div class="pwe-store__btn-container">
                                <a href="#" class="pwe-store__more-button" data-featured="test">'. ( self::lang_pl() ? 'WIĘCEJ' : 'MORE' ) .'</a>
                                <a href="#" class="pwe-store__buy-button pwe-store__redirect-button" target="_blank">'. ( self::lang_pl() ? 'ZAREZERWUJ' : 'BOOK NOW' ) .'</a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="socialSection" category="social" class="pwe-store__social-section pwe-store__section">
                    <div class="pwe-store__services-cards">
                        <!-- Spersonalizowane Smyczki -->
                        <div class="pwe-store__service-card pwe-store__service">
                            <a href="#" data-featured="test1">
                                <div class="pwe-store__service-image">
                                    <img src="/wp-content/plugins/PWElements/media/store/smycze-z-logotypem.webp" alt="Smycze z logotypem">
                                </div>
                                <div class="pwe-store__service-content">
                                    '. ( self::lang_pl() ? '
                                    <h4 class="pwe-store__service-name pwe-store__service-name-mailing">TEST1</h4>
                                    <p>Test1</p>
                                    ':'
                                    <h4 class="pwe-store__service-name pwe-store__service-name-mailing">TEST1</h4>
                                    <p>Test1</p>
                            ...
                            <div class="pwe-store__btn-container">
                                <a href="#" class="pwe-store__more-button" data-featured="test1">'. ( self::lang_pl() ? 'WIĘCEJ' : 'MORE' ) .'</a>
                                <a href="#" class="pwe-store__buy-button pwe-store__redirect-button" target="_blank">'. ( self::lang_pl() ? 'ZAREZERWUJ' : 'BOOK NOW' ) .'</a>
                            </div>
                        </div>
                    </div>
